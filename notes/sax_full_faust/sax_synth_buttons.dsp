...
selector = (button("[01]Cs3") : si.smoo) * harmonics_Cs3 +
           (button("[02]D3") : si.smoo) * harmonics_D3 +
           (button("[03]Ds3") : si.smoo) * harmonics_Ds3 +
           (button("[04]E3") : si.smoo) * harmonics_E3 +
           (button("[05]F3") : si.smoo) * harmonics_F3 +
           (button("[06]Fs3") : si.smoo) * harmonics_Fs3 +
           (button("[07]G3") : si.smoo) * harmonics_G3 +
           (button("[08]Gs3") : si.smoo) * harmonics_Gs3 +
           (button("[09]A3") : si.smoo) * harmonics_A3 +
           (button("[10]As3") : si.smoo) * harmonics_As3 +
           (button("[11]B3") : si.smoo) * harmonics_B3 +
           (button("[12]C4") : si.smoo) * harmonics_C4 +
           (button("[13]Cs4") : si.smoo) * harmonics_Cs4 +
           (button("[14]D4") : si.smoo) * harmonics_D4 +
           (button("[15]Ds4") : si.smoo) * harmonics_Ds4 +
           (button("[16]E4") : si.smoo) * harmonics_E4 +
           (button("[17]F4") : si.smoo) * harmonics_F4 +
           (button("[18]Fs4") : si.smoo) * harmonics_Fs4 +
           (button("[19]G4") : si.smoo) * harmonics_G4 +
           (button("[20]Gs4") : si.smoo) * harmonics_Gs4 +
           (button("[21]A4") : si.smoo) * harmonics_A4 +
           (button("[22]As4") : si.smoo) * harmonics_As4 +
           (button("[23]B4") : si.smoo) * harmonics_B4 +
           (button("[24]C5") : si.smoo) * harmonics_C5 +
           (button("[25]Cs5") : si.smoo) * harmonics_Cs5 +
           (button("[26]D5") : si.smoo) * harmonics_D5 +
           (button("[27]Ds5") : si.smoo) * harmonics_Ds5 +
           (button("[28]E5") : si.smoo) * harmonics_E5 +
           (button("[29]F5") : si.smoo) * harmonics_F5 +
           (button("[30]Fs5") : si.smoo) * harmonics_Fs5 +
           (button("[31]G5") : si.smoo) * harmonics_G5 +
           (button("[32]Gs5") : si.smoo) * harmonics_Gs5;

process = selector * gain;